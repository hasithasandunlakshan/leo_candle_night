...
export default function BookSeats() {
  ...
  return (
    <div className=" bg-primary   min-h-screen  w-[80%]justify-center flex flex-col items-center">
     <h1 className="text-2xl font-bold mb-4 md:text-7xl py-5 text-secondary ">Book Your Seats</h1>
      ...
      <div className=" grid grid-cols-4 sm:grid-cols-8 w-[90%]     md:grid-cols-10 lg:grid-cols-12 gap-2">
        {seats?.map((seat, key) => (
  ...
  className=" cursor-pointer py-1 mt-10 px-10  hover:scale-105 text-black text-base font-bold  overflow-hidden bg-secondary rounded-full ">
 Next
</motion.button>
